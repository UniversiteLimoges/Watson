...
class LinkDAO extends DAO
{
    ...
    /**
     * Return a list of the last 15 last records
     * @return array A list of 15 links.
     */
    public function findFifteenLinksForRss() {
        $sql = "
            SELECT * 
            FROM tl_liens 
        ...
        /**
     * Return a list of all links to show by pagination
     * @return array A list of all links.
     */
    public function LinksPaginated($currentPage, $linksByPage) {
        // calcule la limite en fonction du nombre de liens par page souhaités
        $sql = "
            SELECT * 
            FROM tl_liens 
            ORDER BY lien_id DESC LIMIT ".(($currentPage - 1) * $linksByPage) .",$linksByPage";
        $result = $this->getDb()->fetchAll($sql);
    ...
    public function find($id) {
        ...
        if ($row){
            ...
            throw new \Exception("Pas d'id correspondant trouvé" . $id);
        }
    }
